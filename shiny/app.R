...
ui <- fluidPage(theme = shinytheme("darkly"),
    ...
    p(),
    print("Canadian data provided by Public Health Agency of Canada: "),
    tags$a(href="https://www.canada.ca/en/public-health/services/diseases/2019-novel-coronavirus-infection.html", "https://www.canada.ca/en/public-health/services/diseases/2019-novel-coronavirus-infection.html"),
    p(),
    print("Global data provided by Johns Hopkins University Center for Systems Science and Engineering (JHU CSSE): "),
    tags$a(href="https://github.com/CSSEGISandData/COVID-19", "https://github.com/CSSEGISandData/COVID-19"),
    p(),
    print("Developed by Dylan Ermacora"),
    p()
)
